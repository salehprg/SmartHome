            ...
            modelBuilder.Entity("smarthome.Model.Modules.Devices.SmartplugInfoModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            baseDeviceId = 12,
                            current = 5f,
                            time = new DateTime(2021, 8, 31, 15, 7, 34, 817, DateTimeKind.Local).AddTicks(8231),
                            voltage = 209f,
                            watt = 1045f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 12,
                            current = 6.3f,
                            time = new DateTime(2021, 8, 31, 15, 7, 34, 824, DateTimeKind.Local).AddTicks(901),
                            voltage = 208.8f,
                            watt = 1315.44f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 13,
                            current = 4.4f,
                            time = new DateTime(2021, 8, 31, 15, 7, 34, 824, DateTimeKind.Local).AddTicks(971),
                            voltage = 208.5f,
                            watt = 917.4f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 13,
                            current = 5.7f,
                            time = new DateTime(2021, 8, 31, 15, 7, 34, 824, DateTimeKind.Local).AddTicks(996),
                            voltage = 210.2f,
                            watt = 1198.14f
                        });
                });

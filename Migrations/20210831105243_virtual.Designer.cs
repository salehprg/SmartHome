...
namespace webAPI.Migrations
{
    ...
    [Migration("20210831105243_virtual")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smarthome.Model.Modules.Devices.SmartplugInfoModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            baseDeviceId = 12,
                            current = 5f,
                            time = new DateTime(2021, 8, 31, 15, 22, 42, 694, DateTimeKind.Local).AddTicks(7371),
                            voltage = 209f,
                            watt = 1045f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 12,
                            current = 6.3f,
                            time = new DateTime(2021, 8, 31, 15, 22, 42, 697, DateTimeKind.Local).AddTicks(9666),
                            voltage = 208.8f,
                            watt = 1315.44f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 13,
                            current = 4.4f,
                            time = new DateTime(2021, 8, 31, 15, 22, 42, 697, DateTimeKind.Local).AddTicks(9729),
                            voltage = 208.5f,
                            watt = 917.4f
                        },
                        new
                        {
                            ...
                            baseDeviceId = 13,
                            current = 5.7f,
                            time = new DateTime(2021, 8, 31, 15, 22, 42, 697, DateTimeKind.Local).AddTicks(9754),
                            voltage = 210.2f,
                            watt = 1198.14f
                        });
                });
            ...
            modelBuilder.Entity("smarthome.Model.Modules.Devices.BaseDevice", b =>
                {
                    b.HasOne("smarthome.Model.Room", "Room")

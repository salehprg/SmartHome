...
import { Component, HostListener, Input, OnInit, OnDestroy, Output, EventEmitter } from '@angular/core';
...
export class DatepickerComponent implements OnInit, OnDestroy {
  ...
  @Output() dateOnSelect = new EventEmitter<{ shamsi: string, timestamp: number }>();
  // time
  _timeEnable = true;
  @Input()
